# Signal Clone (Firebase + React Native )

### Show some  <img src="https://github.githubassets.com/images/icons/emoji/unicode/2764.png" width="30" height="30" />   and star the repo to support the project

### Sign up

![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/register.gif)

### Sign in

![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/login.gif)

### Sign in fail

 ![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/login_fail.gif)

### Add Chat
  
![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/add_chat.gif)

### Chatting in Rea time

![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/chatting.gif)

### Keybord avoid View

![ezgif com-crop(1)](https://github.com/aymensp/Signal-Clone-React-Native/blob/master/media/keybord_avoid_iew.gif)
